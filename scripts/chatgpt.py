...
if __name__ == "__main__":
    ...
    parser.add_argument("--requests_filepath", type=str, required=True)
    parser.add_argument("--save_filepath", type=str, default=None)
    parser.add_argument("--request_url", type=str, default="https://api.openai.com/v1/chat/completions")
    parser.add_argument("--api_key", type=str, default=os.getenv("OPENAI_API_KEY"))
    parser.add_argument("--max_requests_per_minute", type=int, default=3_750 * 0.5)
    parser.add_argument("--max_tokens_per_minute", type=int, default=120_000 * 0.5)
    parser.add_argument("--token_encoding_name", type=str, default="cl100k_base")
